...
CREATE TABLE `usuariorol` (
  ...
  `rol_rolId` bigint DEFAULT NULL,
  PRIMARY KEY (`usuarioRolId`),
  KEY `rol_rolId` (`rol_rolId`),
  KEY `usuario_id` (`usuario_id`),
  CONSTRAINT `usuariorol_ibfk_1` FOREIGN KEY (`rol_rolId`) REFERENCES `roles` (`rolId`),
  CONSTRAINT `usuariorol_ibfk_2` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`)
...
INSERT INTO `usuariorol` VALUES (1,10,1),(2,11,1),(3,12,1),(4,13,1),(5,14,1),(6,15,1),(7,18,2);
